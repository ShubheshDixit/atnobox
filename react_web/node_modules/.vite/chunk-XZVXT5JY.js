...
import {
  __rest
} from "./chunk-YDLDBZVM.js";

// node_modules/@firebase/auth/dist/esm2017/index-8fbd02b6.js
var FactorId = {
  PHONE: "phone"
};
var ProviderId = {
...
var PhoneMultiFactorInfo = class extends MultiFactorInfoImpl {
...
function startEnrollPhoneMfa(auth, request) {
  return _performApiRequest(auth, "POST", "/v2/accounts/mfaEnrollment:start", Object.assign({ tenantId: auth.tenantId }, request));
}
function finalizeEnrollPhoneMfa(auth, request) {
  return _performApiRequest(auth, "POST", "/v2/accounts/mfaEnrollment:finalize", Object.assign({ tenantId: auth.tenantId }, request));
}
function withdrawMfa(auth, request) {
  return _performApiRequest(auth, "POST", "/v2/accounts/mfaEnrollment:withdraw", Object.assign({ tenantId: auth.tenantId }, request));
}
...
function startSignInPhoneMfa(auth, request) {
  return _performApiRequest(auth, "POST", "/v2/accounts/mfaSignIn:start", Object.assign({ tenantId: auth.tenantId }, request));
}
function finalizeSignInPhoneMfa(auth, request) {
  return _performApiRequest(auth, "POST", "/v2/accounts/mfaSignIn:finalize", Object.assign({ tenantId: auth.tenantId }, request));
}
 ...
 * limitations under the License.
 */
//# sourceMappingURL=chunk-XZVXT5JY.js.map
