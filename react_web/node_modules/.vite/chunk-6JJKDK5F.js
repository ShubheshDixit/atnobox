...
function uploadBytes$1(ref2, data, metadata) {
  ...
  return ref2.storage.makeRequestWithTokens(requestInfo).then((request) => request.getPromise()).then((finalMetadata) => {
    return {
...
async function list$1(ref2, options) {
  if (options != null) {
 ...
 * limitations under the License.
 */
//# sourceMappingURL=chunk-6JJKDK5F.js.map
